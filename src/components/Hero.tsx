...
const Hero: React.FC = () => {
  ...
  // Single avatar image path - updated to use aman.jpg
  const avatarImage = '/src/assets/aman.jpg';
    ...
    <section id="home" className="pt-24 md:pt-32 pb-16 md:pb-24">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-8 md:mb-0">
          ...
          <h2 className="text-2xl md:text-3xl text-gray-300 mb-6">AI-Powered Developer</h2>
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            <a href="#contact" className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-medium py-3 px-6 rounded-lg text-center transition-all">
              Contact Me
            </a>
            <a href="#projects" className="bg-transparent border border-gray-600 hover:border-gray-400 text-white font-medium py-3 px-6 rounded-lg text-center transition-colors">
              View Projects
            </a>
          </div>
        </div>
        ...
        <div className="md:w-1/2 flex justify-center">
          <div className="relative w-64 h-64 md:w-80 md:h-80">
            ...
            <div className={`absolute inset-0 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 ${speaking ? 'animate-pulse' : ''}`}></div>
            
            {/* AI Avatar with single image */}
            <img 
              src={avatarImage} 
              alt="Aman Raj AI Avatar" 
              className={`absolute inset-2 rounded-full object-cover transition-all duration-500 ${speaking ? 'scale-[1.02]' : 'scale-100'}`}
            />
            ...
            <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
              <button 
                onClick={() => { setExpression('smile'); setSpeaking(true); setTimeout(() => setSpeaking(false), 2000); }}
              ...
              <button 
                onClick={() => { setExpression('thinking'); setSpeaking(true); setTimeout(() => setSpeaking(false), 2000); }}
              ...
              <button 
                onClick={() => { setExpression('excited'); setSpeaking(true); setTimeout(() => setSpeaking(false), 2000); }}
